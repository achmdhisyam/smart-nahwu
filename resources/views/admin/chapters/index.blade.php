                ...
                <tbody class="divide-y divide-[#e6dec9] text-[#2b3a32] text-sm">
                    @forelse($chapters as $chapter)
                        <tr class="hover:bg-[#fbf8f1]/40 transition">
                            <td class="px-6 py-4 font-bold text-[#5c6f60]">{{ $chapter->order_num }}</td>
                            <td class="px-6 py-4 font-bold text-[#1b4332] text-base">{{ $chapter->title }}</td>
                            <td class="px-6 py-4 max-w-xs truncate text-xs text-[#5c6f60]">{{ $chapter->definition }}</td>
                            <td class="px-6 py-4">
                                <span class="px-2.5 py-1 bg-[#1b4332]/10 border border-[#1b4332]/20 text-[#1b4332] text-xs rounded-lg font-bold">
                                    Step {{ $chapter->learning_step }}
                                </span>
                            </td>
